...
Ouvrez PowerShell en tant qu’Administrateur et exécutez cette commande pour définir WSL 2 comme version par défaut lors de l’installation d’une nouvelle distribution Linux :
